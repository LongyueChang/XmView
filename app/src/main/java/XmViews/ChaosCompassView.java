...
import com.example.longyue.xmview.R;
...
public class ChaosCompassView extends View{
    ...
    public ChaosCompassView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mDarkRedPaint.setColor(context.getResources().getColor(R.color.colorAccent));


        mDeepGrayPaint = new Paint();
        mDeepGrayPaint.setStyle(Paint.Style.STROKE);
        mDeepGrayPaint.setAntiAlias(true);
        mDeepGrayPaint.setColor(context.getResources().getColor(R.color.colorBg));


        mLightGrayPaint = new Paint();
        mLightGrayPaint.setStyle(Paint.Style.FILL);
        mLightGrayPaint.setAntiAlias(true);
        mLightGrayPaint.setColor(context.getResources().getColor(R.color.colorAccent));

        mTextPaint = new Paint();
        mTextPaint.setStyle(Paint.Style.STROKE);
        mTextPaint.setAntiAlias(true);
        mTextPaint.setTextSize(80);
        mTextPaint.setColor(context.getResources().getColor(R.color.colorBg));

        mCircumPaint = new Paint();
        mCircumPaint.setStyle(Paint.Style.FILL);
        mCircumPaint.setAntiAlias(true);
        mCircumPaint.setColor(context.getResources().getColor(R.color.colorAccent));

        mOutSideCircumPaint = new Paint();
        mOutSideCircumPaint.setStyle(Paint.Style.FILL);
        mOutSideCircumPaint.setAntiAlias(true);
        mOutSideCircumPaint.setColor(context.getResources().getColor(R.color.colorBg));
        ...
        mNorthPaint.setColor(context.getResources().getColor(R.color.colorAccent));

        mOthersPaint = new Paint();
        mOthersPaint.setStyle(Paint.Style.STROKE);
        mOthersPaint.setAntiAlias(true);
        mOthersPaint.setTextSize(40);
        mOthersPaint.setColor(context.getResources().getColor(R.color.colorBg));
        ...
        mCenterPaint.setColor(context.getResources().getColor(R.color.colorBg));
        ...
        mSamllDegreePaint.setColor(context.getResources().getColor(R.color.colorBg));
        ...
        mAnglePaint.setColor(context.getResources().getColor(R.color.colorAccent));
